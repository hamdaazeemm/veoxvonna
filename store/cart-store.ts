...
//   removeItem: (productId: number, email: string) => Promise<void>
//   updateQuantity: (productId: number, quantity: number, email: string) => Promise<void>
//   clearCart: () => void
// }
...
//         set({ items: cartData.map((item: any) => ({
...
//       if (response.ok) {
//         // Reload the cart after adding item
//         get().loadCart(email)
//       }
//     } catch (error) {
...
//   removeItem: async (productId: number, email: string) => {
//     try {
//       // First find the cart item id to delete
//       const itemToDelete = get().items.find(item => item.product_id === productId)
...
//   updateQuantity: async (productId: number, quantity: number, email: string) => {
//     try {
//       const response = await fetch(`/api/cart/${productId}`, {
//         method: 'PATCH',
//         headers: {
