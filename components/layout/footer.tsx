...
//               Quality fabrics, comfortable fits, and adorable designs.
//             </p>
...
//               <li>
//                 <Link href="/boys" className="text-gray-400 hover:text-white">
//                   Boys Clothing
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/girls" className="text-gray-400 hover:text-white">
//                   Girls Clothing
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/unisex" className="text-gray-400 hover:text-white">
//                   Unisex Clothing
//                 </Link>
//               </li>
//               <li>
...
//               <p className="text-gray-400">Email: info@veoxvonna.com</p>
//               <p className="text-gray-400">WhatsApp: +92 300 1234567</p>
...
//             <img src="/images/payment-methods/visa.svg" alt="Visa" className="h-8" />
//             <img src="/images/payment-methods/mastercard.svg" alt="Mastercard" className="h-8" />
//             <img src="/images/payment-methods/jazzcash.svg" alt="JazzCash" className="h-8" />
//             <img src="/images/payment-methods/easypaisa.svg" alt="EasyPaisa" className="h-8" />
